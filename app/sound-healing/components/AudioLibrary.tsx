...
function FluidWaveform({ playing, color }: { playing: boolean; color: string }) {
  const bars = [4, 12, 8, 18, 10, 15, 6, 11, 4];
  return (
    <div className="flex items-center gap-1 h-12" style={{ willChange: "transform" }}>
      {bars.map((h, i) => (
        <motion.div
          key={i}
      ...
      <div className="max-w-6xl mx-auto w-full relative z-10">
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="space-y-6">
                      ...
                      <FluidWaveform playing={isPlaying} color={track.color} />
                    </div>
                  </div>
                </div>
              </motion.div>
        ...
        >
          <p className="text-[#4a3b32]/50 italic mb-4">
            Want more specialized frequencies?
          </p>
          <button className="px-10 py-4 bg-transparent border border-[#bc6746]/30 text-[#bc6746] rounded-full hover:bg-[#bc6746] hover:text-[#fffdf8] transition-all duration-500 font-mono text-xs uppercase tracking-widest">
            Unlock Full Sanctuary Library
          </button>
        </motion.div>
      </div>
