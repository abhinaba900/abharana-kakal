...
export default function AboutHero() {
  ...
  return (
    <section ref={containerRef} className="relative min-h-screen flex items-center justify-center overflow-hidden px-6 pt-20">
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10 flex flex-col md:flex-row items-center gap-16 md:gap-32">
        ...
        >
          ...
          <p className="text-xl md:text-3xl font-light text-[#4a3b32] leading-relaxed max-w-lg italic opacity-80 pl-2">
            Yoga, sound, and a return to original awareness.
          </p>
        </motion.div>
        ...
        <div className="w-full md:w-1/2 relative group">
          <motion.div 
            className="relative aspect-[3/4] md:aspect-[4/5] rounded-t-[240px] rounded-br-[80px] rounded-bl-[40px] overflow-hidden shadow-[0_50px_120px_rgba(188,103,70,0.2)] z-20 border border-white/40"
          >
            <Image 
      ...
      >
        <span className="text-[10px] font-mono tracking-[0.4em] uppercase text-[#bc6746]/60">Scroll to Explore</span>
